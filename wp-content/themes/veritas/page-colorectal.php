...
<section class="first-section banner-swiper-section colorectal-banner">
    <div class="container-fluid wrapper">
        <div class="row">
            <div class="col-md-5">
                <div class="banner-content" data-aos="fade-right">
                    <h4 class="montserrat-bold parallax-move"><?php echo get_field('colorectal_banner_title', $post_id); ?></h4>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb-div" data-aos="fade-right">
                    <ul class="breadcrumb">
                        <li><a href="<?php echo home_url('/'); ?>/colorectal"><?php echo get_field('services_title_link', $post_id); ?></a></li>
                        <li><?php echo get_field('colorectal_banner_title', $post_id); ?></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="row services-des-row">
            <div class="col-md-4">
                ...
                <div class="services-unlist-div">
                    <ul class="squarelist" data-aos="fade-right">
                        <li class="active">
                            <a href="<?php echo home_url('/'); ?>/colorectal"><?php echo get_field('colorectal_banner_title', $post_id); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo home_url('/'); ?>/upper-gastrointestinal-malignancies"><?php echo get_field('upper_gastrointestinal_title_link', $post_id); ?></a>
                        </li>
                        <li>
                                ...
                                <div class="swiper-slide">
                                    <div class="service-video-swiper-div">
                                        ...
                                        <div class="service-video-swiper-content">
                                            <h6><?php echo get_field('colorectal_video_first_swiper_title', $post_id); ?></h6>
                                            <p><?php echo get_field('colorectal_video_first_swiper_description', $post_id); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="service-video-swiper-div">
                                        ...
                                        <div class="service-video-swiper-content">
                                            <h6><?php echo get_field('colorectal_video_second_swiper_title', $post_id); ?></h6>
                                            <p><?php echo get_field('colorectal_video_second_swiper_description', $post_id); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="service-video-div" data-aos="fade-right">
                    <div class="service-video-head row">
                        <div class="col-md-12">
                            <h6 class="montserrat-bold"><?php echo get_field('colorectal_blog_title', $post_id); ?></h6>
                        </div>
                    </div>
                    <div class="service-video-swiper">
                                            ...
                                            <div class="col-md-7">
                                                <div class="service-video-swiper-content">
                                                    <a href="<?php echo home_url('/'); ?>/blog">
                                                        <h5><?php echo get_field('colorectal_blog_first_swiper_title', $post_id); ?></h5>
                                                        <p><?php echo get_field('colorectal_blog_first_swiper_description', $post_id); ?></p>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="service-video-swiper-div">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="service-video-swiper-content">
                                                    <a href="<?php echo home_url('/'); ?>/blog">
                                                        <h5><?php echo get_field('colorectal_blog_second_swiper_title', $post_id); ?></h5>
                                                        <p><?php echo get_field('colorectal_blog_second_swiper_description', $post_id); ?></p>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <div class="dropdown" id="tell_us_drop_down">
                                <button type="button" class="btn btn-primary dropdown-toggle form-dropdown" data-toggle="dropdown" id="selected">
                                    <?php echo get_field('colorectal_banner_title', $post_id); ?>
                                </button>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="<?php echo home_url('/'); ?>/colorectal"><?php echo get_field('colorectal_banner_title', $post_id); ?></a>
                                    <a class="dropdown-item" href="<?php echo home_url('/'); ?>/upper-gastrointestinal-malignancies"><?php echo get_field('upper_gastrointestinal_title_link', $post_id); ?></a>
                ...
                <div class="service-contents-div" data-aos="fade-left">
                    <h5 class="montserrat-bold"><?php echo get_field('colorectal_banner_title', $post_id); ?></h5>
                    <p class="common-para grey-color"><?php echo get_field('colorectal_section_description', $post_id); ?></p>
                    <h6 class="montserrat-bold"><?php echo get_field('colorectal_factors_title', $post_id); ?></h6>
                    <p class="common-para grey-color"><?php echo get_field('colorectal_factors_description', $post_id); ?></p>
                    <ul class="small-circle-bullet">
                        <li><?php echo get_field('colorectal_factor_list_one', $post_id); ?></li>
                        <li><?php echo get_field('colorectal_factor_list_two', $post_id); ?></li>
                        <li><?php echo get_field('colorectal_factor_list_three', $post_id); ?></li>
                        <li><?php echo get_field('colorectal_factor_list_four', $post_id); ?></li>
                        <li><?php echo get_field('colorectal_factor_list_five', $post_id); ?></li>
                        <li><?php echo get_field('colorectal_factor_list_six', $post_id); ?></li>
                    </ul>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div id="accordionExample" class="accordion">
                                ...
                                <div class="card">
                                    <div id="headingOne" class="card-header">
                                        <h6 class="montserrat-bold"><a href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="d-block position-relative  collapsible-link "><?php echo get_field('colorectal_symptoms_title', $post_id); ?></a></h6>
                                    </div>
                                    <div id="collapseOne" aria-labelledby="headingOne" data-parent="#accordionExample" class="collapse show">
                                        <div class="card-body">
                                            <p class="common-para grey-color"><?php echo get_field('colorectal_symptoms_description', $post_id); ?></p>
                                            <div class="services-accor-icons-div row">
                                                <div class="col-md-4">
                                                    <div class="services-accor-icons text-center">
                                                        ...
                                                        <p class="golden-color"><?php echo get_field('colorectal_symptom_one', $post_id); ?></p>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="services-accor-icons text-center">
                                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/services/service-icon2.svg" class="img-fluid" />
                                                        <p class="golden-color"><?php echo get_field('colorectal_symptom_two', $post_id); ?></p>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="services-accor-icons text-center">
                                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/services/service-icon3.svg" class="img-fluid" />
                                                        <p class="golden-color"><?php echo get_field('colorectal_symptom_three', $post_id); ?></p>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="services-accor-icons text-center">
                                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/services/service-icon4.svg" class="img-fluid" />
                                                        <p class="golden-color"><?php echo get_field('colorectal_symptom_four', $post_id); ?></p>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="services-accor-icons text-center">
                                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/services/service-icon5.svg" class="img-fluid" />
                                                        <p class="golden-color"><?php echo get_field('colorectal_symptom_five', $post_id); ?></p>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="services-accor-icons text-center">
                                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/services/service-icon6.svg" class="img-fluid" />
                                                        <p class="golden-color"><?php echo get_field('colorectal_symptom_six', $post_id); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <p class="common-para grey-color"><?php echo get_field('colorectal_symptoms_para', $post_id); ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div id="headingTwo" class="card-header">
                                        <h6 class="montserrat-bold"><a href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo" class="d-block position-relative collapsed  collapsible-link "><?php echo get_field('diagnosis_title', $post_id); ?></a></h6>
                                    </div>
                                    <div id="collapseTwo" aria-labelledby="headingTwo" data-parent="#accordionExample" class="collapse show">
                                        <div class="card-body">
                                            <p class="common-para grey-color"><?php echo get_field('diagnosis_description', $post_id); ?></p>
                                            ...
                                            <div class="services-nav-tabs-div row">
                                                <div class="col-md-12">
                                                    ...
                                                    <ul class="nav services-nav-tabs nav-tabs" role="tablist">
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link" data-toggle="tab" href="#menu4"><span><?php echo get_field('diagnosis_blood_test_title', $post_id); ?></span> </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" data-toggle="tab" href="#menu5"><span><?php echo get_field('diagnosis_molecular_testing_title', $post_id); ?></span> </a>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div id="menu3" class="container tab-pane fade">
                                                            <div class="services-tabs-content-card">
                                                                ...
                                                                <div class="tabs-content-text">
                                                                    ...
                                                                    <ul class="small-circle-bullet">
                                                                        <li><?php echo get_field('diagnosis_diagnostic_imaging_list_one', $post_id); ?></li>
                                                                        <li><?php echo get_field('diagnosis_diagnostic_imaging_list_two', $post_id); ?></li>
                                                                        <li><?php echo get_field('diagnosis_diagnostic_imaging_list_three', $post_id); ?></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div id="menu4" class="container tab-pane fade">
                                                            <div class="services-tabs-content-card">
                                                                ...
                                                                <div class="tabs-content-text">
                                                                    <h5 class="montserrat-bold"><?php echo get_field('diagnosis_blood_test_title', $post_id); ?></h5>
                                                                    <p class="common-para grey-color"><?php echo get_field('diagnosis_blood_test_description', $post_id); ?></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div id="menu5" class="container tab-pane fade">
                                                            <div class="services-tabs-content-card">
                                                                <div class="tabs-content-img">
                                                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/services/colorectal/Molecular Test.jpg" class="img-fluid" />
                                                                </div>
                                                                <div class="tabs-content-text">
                                                                    <h5 class="montserrat-bold"><?php echo get_field('diagnosis_molecular_testing_title', $post_id); ?></h5>
                                                                    <p class="common-para grey-color"><?php echo get_field('diagnosis_molecular_testing_description', $post_id); ?></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="card">
                                <div id="headingThree" class="card-header">
                                    <h6 class="montserrat-bold"><a href="#" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree" class="d-block position-relative collapsed  collapsible-link "><?php echo get_field('treatment_title', $post_id); ?></a></h6>
                                </div>
                                <div id="collapseThree" aria-labelledby="headingThree" data-parent="#accordionExample" class="collapse show">
                                    <div class="card-body">
                                        <p class="common-para grey-color"><?php echo get_field('treatment_description', $post_id); ?></p>
                                        <p class="common-para grey-color"><?php echo get_field('treatment_description_para_one', $post_id); ?></p>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="plus-icon-points-div">
                                                        ...
                                                        <p class="grey-color"><?php echo get_field('treatment_targeted_drug_description', $post_id); ?></p>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="plus-icon-points-div">
                                                        ...
                                                        <p class="grey-color"><?php echo get_field('treatment_radiation_therapy_para_one', $post_id); ?></p>
                                                        <ul class="circle-list">
                                                            <li><?php echo get_field('treatment_radiation_therapy_para_two', $post_id); ?></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <p class="common-para grey-color"><?php echo get_field('treatment_description_para_two', $post_id); ?></p>
                                        <p class="common-para grey-color"><?php echo get_field('treatment_description_para_three', $post_id); ?></p>
                                        <p class="common-para grey-color"><?php echo get_field('treatment_description_para_four', $post_id); ?></p>
                                    </div>
                                </div>
                            </div>
