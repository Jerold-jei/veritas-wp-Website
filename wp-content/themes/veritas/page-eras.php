            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="banner-content" data-aos="fade-right">
                        <h4 class="montserrat-bold white-color"><?php echo get_field('eras_banner_title', $post_id); ?></h4> 
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="breadcrumb-div">
                    <ul class="breadcrumb" data-aos="fade-right">
                        ...
                        <li><?php echo get_field('eras_banner_title', $post_id); ?></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="row services-des-row">
            <div class="col-md-4">
                ...
                <div class="services-unlist-div">
                    <ul class="squarelist" data-aos="fade-right">
                        ...
                        <li class="active">
                            <a href="<?php echo home_url('/'); ?>/eras"><?php echo get_field('eras_banner_title', $post_id); ?></a>
                        </li>
                    </ul>
                </div>
                <!-- Services Videos -->
                                ...
                                <div class="swiper-slide">
                                    <div class="service-video-swiper-div">
                                        ...
                                        <div class="service-video-swiper-content">
                                            <h6><?php echo get_field('fluorescence_video_first_swiper_title', $post_id); ?></h6>
                                            <p><?php echo get_field('fluorescence_video_first_swiper_description', $post_id); ?></p> 
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="service-video-swiper-div">
                                        ...
                                        <div class="service-video-swiper-content">
                                            <h6><?php echo get_field('fluorescence_video_second_swiper_title', $post_id); ?></h6>
                                            <p><?php echo get_field('fluorescence_video_second_swiper_description', $post_id); ?></p> 
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <div class="dropdown" id="tell_us_drop_down">
                                <button type="button" class="btn btn-primary dropdown-toggle form-dropdown"
                                    ...
                                    <?php echo get_field('eras_banner_title', $post_id); ?>
                                </button>
                                ...
                                <a class="dropdown-item" href="<?php echo home_url('/'); ?>/eras"><?php echo get_field('eras_banner_title', $post_id); ?> </a> 
                                </div>
                ...
                <div class="service-contents-div"  data-aos="fade-left">
                    <h5 class="montserrat-bold"><?php echo get_field('eras_section_title', $post_id); ?></h5>
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/latest-procedure/Asset 2-100.jpg" class="img-fluid pb-4 pt-4" />

                    <p class="common-para grey-color"><?php echo get_field('eras_section_para_one', $post_id); ?></p> 
                    
                    <p class="common-para grey-color"><?php echo get_field('eras_section_para_two', $post_id); ?></p> 
                    
                    <p class="common-para grey-color"><?php echo get_field('eras_section_para_three', $post_id); ?></p> 
                </div>
                            ...
                            <div id="accordionExample" class="accordion">
                                <div class="card">
                                    <div id="headingTwo" class="card-header">
                                        <h6 class="montserrat-bold"><a href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo" class="d-block position-relative collapsed  collapsible-link "><?php echo get_field('eras_how_it_works_title', $post_id); ?>
</a></h6>
                                    </div>
                                    <div id="collapseTwo" aria-labelledby="headingTwo" data-parent="#accordionExample" class="collapse show">
                                        <div class="card-body">
                                            ...
                                            <ul class="small-circle-bullet">
                                                <li><span class="golden-color"><?php echo get_field('eras_how_it_works_first_para_title', $post_id); ?></span> <?php echo get_field('eras_how_it_works_first_para', $post_id); ?></li>

                                                <li><span class="golden-color"><?php echo get_field('eras_how_it_works_second_para_title', $post_id); ?></span> <?php echo get_field('eras_how_it_works_second_para', $post_id); ?></li>
                                                
                                                <li> <span class="golden-color"><?php echo get_field('eras_how_it_works_third_para_title', $post_id); ?></span> <?php echo get_field('eras_how_it_works_third_para', $post_id); ?></li> 
                                                
                                                <li> <span class="golden-color"><?php echo get_field('eras_how_it_works_fourth_para_title', $post_id); ?></span> <?php echo get_field('eras_how_it_works_fourth_para', $post_id); ?></li> 
                                                
                                                <li> <span class="golden-color"><?php echo get_field('eras_how_it_works_fivth_para_title', $post_id); ?></span> <?php echo get_field('eras_how_it_works_fivth_para', $post_id); ?></li> 
                                            </ul>
                                            <p class="common-para grey-color"><?php echo get_field('eras_section_para_four', $post_id); ?></p>
                                            
                                            <p class="common-para grey-color"><?php echo get_field('eras_section_para_five', $post_id); ?></p>
                                        </div>
                                    </div>
                                </div> 
                            </div>
