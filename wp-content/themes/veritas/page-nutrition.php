...
/* Template Name: Nutrition & Psychological Counselling Page */
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="banner-content" data-aos="fade-right">
                    <h4 class="montserrat-bold"><?php echo get_field('nutrition_psychological_banner_title', $post_id); ?></h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="breadcrumb-div">
                    <ul class="breadcrumb" data-aos="fade-right">
                        ...
                        <li><?php echo get_field('nutrition_psychological_banner_title', $post_id); ?></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="row services-des-row">
            <div class="col-md-4">
                ...
                <div class="services-unlist-div">
                    <ul class="squarelist" data-aos="fade-right">
                        ...
                        <li>
                            <a href="<?php echo home_url('/'); ?>/multidisciplinary-treatment"><?php echo get_field('multidisciplinary_title_link', $post_id); ?></a>
                        </li>
                    </ul>
                </div>
                <!-- Services Videos -->
                                ...
                                <div class="swiper-slide">
                                    <div class="service-video-swiper-div">
                                        ...
                                        <div class="service-video-swiper-content">
                                            <h6><?php echo get_field('nutrition_side_first_swiper_title', $post_id); ?></h6>
                                            <p><?php echo get_field('nutrition_side_first_swiper_description', $post_id); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="service-video-swiper-div">
                                        ...
                                        <div class="service-video-swiper-content">
                                            <h6><?php echo get_field('nutrition_side_second_swiper_title', $post_id); ?></h6>
                                            <p><?php echo get_field('nutrition_side_second_swiper_description', $post_id); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <div class="dropdown" id="tell_us_drop_down">
                                <button type="button" class="btn btn-primary dropdown-toggle form-dropdown" data-toggle="dropdown" id="selected">
                                    <?php echo get_field('nutrition_title_link', $post_id); ?>
                                </button>
                                <div class="dropdown-menu">

                                    <a class="dropdown-item" href="<?php echo home_url('/'); ?>/prevention-screening-clinics"><?php echo get_field('prevention_screening_title_link', $post_id); ?></a>
                                    <a class="dropdown-item" href="<?php echo home_url('/'); ?>/genetic-testing-counselling"><?php echo get_field('genetic_title_link', $post_id); ?></a>
                                    <a class="dropdown-item" href="<?php echo home_url('/'); ?>/nutrition-psychological-counselling"><?php echo get_field('nutrition_title_link', $post_id); ?></a>
                                    <a class="dropdown-item" href="<?php echo home_url('/'); ?>/multidisciplinary-treatment"><?php echo get_field('multidisciplinary_title_link', $post_id); ?></a>
                                </div>
                ...
                <div class="service-contents-div" data-aos="fade-left">
                    <h5 class="montserrat-bold"><?php echo get_field('nutrition_psychological_banner_title', $post_id); ?></h5>
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/prevention/Asset 2-100.jpg" class="img-fluid pb-4 pt-4" />

                    <p class="common-para grey-color"><?php echo get_field('nutrition_section_para_one', $post_id); ?></p>

                    <p class="common-para grey-color"><?php echo get_field('nutrition_section_para_two', $post_id); ?></p>

                    <p class="common-para grey-color"><?php echo get_field('nutrition_section_para_three', $post_id); ?></p>

                    <p class="common-para grey-color"><?php echo get_field('nutrition_section_para_four', $post_id); ?></p>

                    <p class="common-para grey-color"><?php echo get_field('nutrition_section_para_five', $post_id); ?></p>
                </div>
                            ...
                            <div id="accordionExample" class="accordion">
                                ...
                                <div class="card">
                                    <div id="headingOne" class="card-header">
                                        <h6 class="montserrat-bold"><a href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="d-block position-relative  collapsible-link "><?php echo get_field('nutrition_question_title', $post_id); ?></a></h6>
                                    </div>
                                    <div id="collapseOne" aria-labelledby="headingOne" data-parent="#accordionExample" class="collapse show">
                                        <div class="card-body">
                                            <div class="plus-icon-points">
                                                <p class="common-para grey-color"><?php echo get_field('nutrition_question_description', $post_id); ?></p>
                                                <ul class="small-circle-bullet">
                                                    <li><?php echo get_field('nutrition_question_one', $post_id); ?></li>
                                                    <li><?php echo get_field('nutrition_question_two', $post_id); ?></li>
                                                    <li><?php echo get_field('nutrition_question_three', $post_id); ?></li>
                                                    <li><?php echo get_field('nutrition_question_four', $post_id); ?></li>
                                                    <li><?php echo get_field('nutrition_question_five', $post_id); ?></li>
                                                    <li><?php echo get_field('nutrition_question_six', $post_id); ?></li>
                                                    <li><?php echo get_field('nutrition_question_seven', $post_id); ?></li>
                                                </ul>
                                                </ul>
                                            </div>
