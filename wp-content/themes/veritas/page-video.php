...
<section class="first-section banner-swiper-section video-banner">  
        <div class="container-fluid wrapper">     
        <div class="row">
            <div class="col-md-5">
                <div class="blog-content" data-aos="fade-right">
                    <!-- <h4 class="montserrat-bold">Videos</h4> -->
        ...
        <div class="row flex-center-row">
            <div class="col-md-8">
                ...
                <?php if(get_theme_mod('header_text_field')):?>
                        <h4 class="montserrat-bold green-color common-head"><?php echo get_theme_mod('header_text_field')?></h4>
                    <?php endif; ?>    
                    <!-- <h4 class="montserrat-bold green-color common-head">Videos</h4> -->
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="testi-video-card" data-aos="fade-up">
                    ...
                    <?php endif; ?>  
                        <!-- <h6 class="montserrat-bold green-color">Vanakkam Tamizha with Cancer Specialist Dr. Venkat</h6> -->
